...
public:
	...
	void func_limpeza_total_dos_dados();
...
/*
MODELO DE CLASSE CONFIGURADA PARA 1000 UNIDADES DE ALOCAMENTO INDIVIDUAL

QUANTIDADE DO ALOCAMENTO PODE SER CONFIGURADA MANUALMENTE
*/
...
void modelo_EntradaSaida_dado_autoalocavel::func_limpeza_total_dos_dados() {
	if (this->disponibilidade == 1) {
		this->disponibilidade = 0;
		dados_classe_autoalocavel[this->numero_da_classe].vetor_char_da_classe.clear();
		this->tamanho_total_classe = 0;
